...
export const EN_PLAIN: Record<string, string> = {
  "偏好设置": "Preferences",
  "关闭偏好设置": "Close preferences",
  "关闭诊断": "Close diagnosis",
  "关闭通知": "Dismiss notice",
  "管理器已更新；Codex 客户端未重启。": "Manager updated; the Codex client was not restarted.",
  "上次更新结果未确认，请核对已安装的管理器版本。": "The last update result is unconfirmed. Check the installed manager version.",
  "界面外观与本机应用操作": "Appearance and local application controls",
  "外观主题": "Appearance",
  "浅色模式": "Light mode",
  "深色模式": "Dark mode",
  "界面语言": "Language",
  "版本与更新": "Version and updates",
  "版本读取中…": "Loading version…",
  "只在确认后重启官方 Codex 客户端。": "Restart the official Codex client only after confirmation.",
  "已归档会话": "Archived sessions",
  "已选择 {0} / {1} 个会话": "{0} of {1} sessions selected",
  "归档可恢复，不释放磁盘空间；原 provider 标记保留。": "Archived sessions can be restored without freeing disk space; their original provider is retained.",
  "查看、归档与管理本地会话；切换供应商后仅适配活动会话。": "Review and archive local sessions. Provider adaptation affects active sessions only.",
  "会话视图": "Session views",
  "原生归档，可随时恢复": "Native archive, restorable at any time",
  "自动归档已启用": "Auto-archive on",
  "自动归档未启用": "Auto-archive off",
  "只检查活动会话": "Active sessions only",
  "会话标题与标识": "Session title and ID",
  "绑定 provider": "Bound provider",
  "最后更新": "Last updated",
  "操作": "Actions",
  "归档会话可随时恢复；归档不会释放磁盘空间。": "Archived sessions are restorable; archiving does not free disk space.",
  "本地会话会在 Codex 创建任务后显示在这里。": "Local sessions appear here after Codex creates a task.",
  "会话列表刷新失败，请手动刷新后核对状态。": "The session list did not refresh. Refresh manually to verify the outcome.",
  ...
  "核心尚未连接": "The core is not connected",
  "核心连接已断开": "Core connection lost",
  "正在连接本机核心…": "Connecting to the local core…",
  "另一个管理器正在使用本机配置，请先退出它再重新连接。": "Another manager owns this configuration. Quit it before reconnecting.",
  "草稿仍保留在页面中；中断请求的结果尚未确认，请重新连接并读取配置。": "Your draft is retained. The interrupted request's outcome is unconfirmed; reconnect and read the configuration.",
  "重新连接": "Reconnect",
  "连接中…": "Connecting…",
  "供应商与模型将一起保存": "Provider and models are saved together",
  ...
  "安装更新": "Install update",
  "更新无法写入当前安装位置。请将 app 放入你有写入权限的「应用程序」目录，再启动并重试。": "The install location is not writable. Move the app to an Applications folder you can write to, then launch it and retry.",
  "更新安装": "Update install",
  "最新版本": "Latest version",
  ...
  "诊断未完成，请检查核心连接后重试。": "Diagnosis did not finish. Check the core connection and try again.",
  "纯 API＋Responses API；图像工具已关闭，可单独开启。": "Pure API + Responses API; the image tool is off and can be enabled separately.",
  "诊断中": "Diagnosing",
  "异常": "Error",
  "完成": "Complete",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "正在准备安装 {0}，管理器随后退出并交给安装程序。": "Preparing {0}; the manager will then exit and hand off to the installer.",
